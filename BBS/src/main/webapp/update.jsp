	...
	<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse" id="bs-exapmle-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<liclass="active"><a href="bbs.jsp">게시판</a></li>
				</ul>										
		</div>
	</nav>
	<div class="container">
		 ...
		 <form method="post" action="updateAction.jsp?bbsID=<%=bbsID%> ">
			<table class="table table-stirped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						<td><textarea class="form-control" placeholder="글 내용을 입력해주세요." name="bbsContent" maxlength="4096" style="height: 500px;"> <%= bbs.getBbsContent()%> </textarea></td>
					</tr>										
				</tbody>				
			</table>
