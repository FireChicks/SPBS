...
<body>
	...
	<script>
		function check() {
			...
			document.getElementById("userProf").value	=   document.getElementById("userProfile").value
		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top : 20px;">
				<form method="post" action="profileAction.jsp" >
					<h3 style="text-align: center;">프로필 변경</h3>
					<div class="form-group">
						<a>아이디</a><br>
						<input type="text" id="input" class="form-control" placeholder="<%=userID%>" name="userID" maxlength="20" disabled>						
					</div>					
					<div class="form-group">
						<a>이름</a><br>
